...
client = cohere.Client(api_key="wftDMLCrVU2wdJpiE45HlDwKpj5e3iQhTjX1pINl")
...
for result in response:
    if "negative" in result.prediction and result.confidence >0.8:
        neg_count += 1
    elif "positive" in result.prediction and result.confidence >0.8:
        pos_count += 1
